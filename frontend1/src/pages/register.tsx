    ...
    <Box sx={authStyles.pageWrapper}>
      <Paper sx={authStyles.card}>
        ...
        <AppButton
          ...
          disabled={loading} sx={authStyles.primaryButton}
        >
